...
import (
	...
	"github.com/LaurieRhodes/PUBLIC-Golang-MCP-Servers/MCP-Bash-Golang/pkg/bash"
	"github.com/LaurieRhodes/PUBLIC-Golang-MCP-Servers/MCP-Bash-Golang/pkg/config"
	"github.com/LaurieRhodes/PUBLIC-Golang-MCP-Servers/MCP-Bash-Golang/pkg/mcp"
)
...
func main() {
	...
	fmt.Fprintf(os.Stderr, "Bash MCP Server v1.0.0 starting on stdin/stdout\n")
